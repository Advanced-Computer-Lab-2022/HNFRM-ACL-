...
module.exports = {createCourse,viewCourse,rateCourse,instructorViewCourses
    ,uploadVideo,searchAll,filter,viewSubtitle,viewCourses,discount
    ,searchInstructor,filterInstructor,Promotion};
