        ...
        return(
            ...
            >
                ...
                <FormGroup>
                    ...
                    <FormControlLabel control={<Checkbox onChange = {e =>setfilterConst("rating")}/>} label="Rating" />
                    <FormControlLabel control={<Checkbox onChange = {e =>setfilterConst("subject")} />} label="Subject" />
                </FormGroup>
                <Button variant="text" onClick ={() => window.location.href=`/results?filter=${filter}&check=${filterConst}`}
              key={filter}>
                filter
                </Button>
            <br></br>
